...
<div class="well">
    ...
    <form class="form-signin form-horizontal" role="form" action="adminchercheur/ajouter" method="post">
    ...
    <form class="form-signin form-horizontal" role="form" action="adminchercheur/supprimer" method="post">
        <div class="form-group">
            <div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
